...
void Order:: spaghetti() 
{
	...
	cout << "\n\t --- TENSHI FOOD ORDERING SYSTEM | Spaghetti ---";
...
void Order:: carbonara() 
{
	clearScreen();
	
	cout << "\n\t --- TENSHI FOOD ORDERING SYSTEM | Carbonara ---";
	
	cout << "\n\n\t [Choice 1] Small Bowl Carbonara \t Php 30.00";
	cout << "\n\t [Choice 2] Medium Bowl Carbonara \t Php 45.00";
	cout << "\n\t [Choice 3] Large Bowl Carbonara \t Php 60.00";
	...
	{
		case '1':
			orderNames.push_back("Small Bowl Carbonara");
			orderPrices.push_back(quantity * 30.00);
			break;
			
		case '2':
			orderNames.push_back("Medium Bowl Carbonara");
			orderPrices.push_back(quantity * 45.00);
			break;
			
		case '3':
			orderNames.push_back("Large Bowl Carbonara");
			orderPrices.push_back(quantity * 60.00);
			break;
...
void Order:: pansitPalabok() 
{
	...
	cout << "\n\t --- TENSHI FOOD ORDERING SYSTEM | Pansit Palabok ---";
...
void Order:: friedChicken() 
{
	...
	cout << "\n\t --- TENSHI FOOD ORDERING SYSTEM | Fried Chicken ---";
...
void Order:: sinigang() 
{
	...
	cout << "\n\t --- TENSHI FOOD ORDERING SYSTEM | Sinigang ---";
...
void Order:: drinks() 
{
	...
	cout << "\n\t --- TENSHI FOOD ORDERING SYSTEM | Drinks ---";
...
void Order::receipt()
{
	...
	cout << "\n 1176 Zone 2 National Highway San Isidro, Iriga City";
	...
	cout << "\n\n Thank you for ordering in TENSHI!\n";
